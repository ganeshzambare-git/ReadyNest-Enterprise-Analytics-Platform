...
st.set_page_config(page_title="Monitoring & Observability - ReadyNest", layout="wide")

render_feature_module(
    title="Monitoring & Observability",
    description="Track pipeline health, data freshness, and system uptime.",
    business_value="Reduces mean-time-to-resolution (MTTR) for data pipeline failures.",
    metrics=[
