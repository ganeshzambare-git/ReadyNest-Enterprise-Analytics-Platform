...
st.set_page_config(page_title="Customer Segmentation - ReadyNest", layout="wide")

render_feature_module(
    title="Customer Segmentation",
    description="Group customers using k-means and RFM modeling techniques.",
    business_value="Allows hyper-personalized marketing campaigns, lifting conversion by up to 25%.",
    metrics=[
