...
st.set_page_config(page_title="Data Ingestion - ReadyNest", layout="wide")

render_feature_module(
    title="Data Ingestion",
    description="Automate the collection of raw data from multiple sources into a centralized lake.",
    business_value="Ensures a single source of truth for all enterprise analytics, reducing data silos by 80%.",
    metrics=[
