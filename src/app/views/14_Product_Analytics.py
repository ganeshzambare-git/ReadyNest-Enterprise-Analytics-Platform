...
st.set_page_config(page_title="Product Analytics - ReadyNest", layout="wide")

render_feature_module(
    title="Product Analytics",
    description="Cohort analysis, retention curves, and stickiness metrics.",
    business_value="Identifies the 'Aha!' moment that turns free users into paying subscribers.",
    metrics=[
