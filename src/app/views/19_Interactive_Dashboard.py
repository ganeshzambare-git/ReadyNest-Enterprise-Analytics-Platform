...
st.set_page_config(page_title="Interactive Dashboard - ReadyNest", layout="wide")

render_feature_module(
    title="Interactive Dashboard",
    description="Customizable drag-and-drop analytics canvas.",
    business_value="Democratizes data access by allowing non-technical users to build their own views.",
    metrics=[
