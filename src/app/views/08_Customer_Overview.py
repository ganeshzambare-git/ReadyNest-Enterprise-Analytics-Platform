...
st.set_page_config(page_title="Customer Overview - ReadyNest", layout="wide")

render_feature_module(
    title="Customer Overview",
    description="High-level summary of the entire customer base and key demographics.",
    business_value="Provides executive alignment on who the core customer base is today.",
    metrics=[
