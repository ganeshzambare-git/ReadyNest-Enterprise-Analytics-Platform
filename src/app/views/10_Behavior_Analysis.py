...
st.set_page_config(page_title="Behavior Analysis - ReadyNest", layout="wide")

render_feature_module(
    title="Behavior Analysis",
    description="Track and analyze how users interact with your product or service.",
    business_value="Identifies friction points in the user journey, improving retention rates.",
    metrics=[
